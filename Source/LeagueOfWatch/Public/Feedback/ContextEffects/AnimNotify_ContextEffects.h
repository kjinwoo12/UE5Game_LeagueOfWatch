...
#include "AnimNotify_ContextEffects.generated.h"

USTRUCT(BlueprintType)
struct LEAGUEOFWATCH_API FContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct LEAGUEOFWATCH_API FContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct LEAGUEOFWATCH_API FContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct LEAGUEOFWATCH_API FContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/LeagueOfWatch.ContextEffectsLibrary"))
...
class LEAGUEOFWATCH_API UAnimNotify_ContextEffects : public UAnimNotify
{
	GENERATED_BODY()
...
public:
	...
	void SetParameters(FGameplayTag EffectIn, 
					   ...
					   FContextEffectAnimNotifyVFXSettings VFXPropertiesIn,
					   FContextEffectAnimNotifyAudioSettings AudioPropertiesIn,
					   bool bAttachedIn, 
					   FName SocketNameIn, 
					   bool bPerformTraceIn, 
					   FContextEffectAnimNotifyTraceSettings TracePropertiesIn
	);
#endif
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
};
