...
bool UContextEffectsSubsystem::GetContextFromSurfaceType(
...
void UContextEffectsSubsystem::LoadAndAddContextEffectsLibraries(AActor* OwningActor,
																	 TSet<TSoftObjectPtr<UContextEffectsLibrary>> ContextEffectsLibraries)
{
